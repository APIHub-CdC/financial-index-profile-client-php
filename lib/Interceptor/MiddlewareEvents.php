...
namespace FinacialIndexProfile\Client\Interceptor;
...
use \FinacialIndexProfile\Client\Interceptor\KeyHandler;
use \FinacialIndexProfile\Client\Interceptor\MyLogger;
use \FinacialIndexProfile\Client\Model\Errors;
use \FinacialIndexProfile\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\FinacialIndexProfile\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \FinacialIndexProfile\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \FinacialIndexProfile\Client\Model\Errores(["errors" => [$error]]);
